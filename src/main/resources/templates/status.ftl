                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card flex-row align-items-center align-items-stretch border-0">
                        ...
                        <div class="col-8 py-3 bg-primary rounded-right">
                            <div class="h2 mt-0">
                                <#if content.status.metrics['upload']??>${content.status.metrics['upload']}<#else>0</#if> /
                                <small> (<#if content.status.latestMetrics['upload']??>${content.status.latestMetrics['upload']}<#else>0</#if>)</small>
                            </div>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card flex-row align-items-center align-items-stretch border-0">
                        ...
                        <div class="col-8 py-3 bg-purple rounded-right">
                            <div class="h2 mt-0">
                                <#if content.status.metrics['download']??>${content.status.metrics['download']}<#else>0</#if> /
                                <small> (<#if content.status.latestMetrics['download']??>${content.status.latestMetrics['download']}<#else>0</#if>)</small>
                            </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-12">
                    ...
                    <div class="card flex-row align-items-center align-items-stretch border-0">
                        ...
                        <div class="col-8 py-3 bg-green rounded-right">
                            <div class="h2 mt-0">
                                ${helper.sizeToBytes(content.status.availableMemory, false)} /
                                <small>${helper.sizeToBytes(content.status.totalMemory, false)}</small>
                            </div>
