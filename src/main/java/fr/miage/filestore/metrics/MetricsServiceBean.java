...
public class MetricsServiceBean implements MetricsService {
    ...
    private void init() {
        ...
        LOGGER.log(Level.INFO, "Scheduling job for purging old metrics");
        executorService.scheduleAtFixedRate(worker,1, 1, TimeUnit.HOURS);
    }
    ...
    public Long getLatestMetric(String key) {
        LOGGER.log(Level.INFO, "get latest metric for key: " + key);
